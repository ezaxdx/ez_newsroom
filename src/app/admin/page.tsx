...
const MOCK: NewsItem[] = [
  {
    ...
    category: "MICE", priority_score: 100, is_published: true, display_order: 1,
  ...
  },
  {
    ...
    content_long: "", implications: "", image_url: null, original_url: "#",
    category: "AI", priority_score: 90, is_published: true, display_order: 2,
    published_at: new Date().toISOString(),
  },
  {
    ...
    content_long: "", implications: "", image_url: null, original_url: "#",
    category: "AI", priority_score: 70, is_published: true, display_order: 3,
    published_at: new Date().toISOString(),
  },
  {
    ...
    content_long: "", implications: "", image_url: null, original_url: "#",
    category: "MICE", priority_score: 60, is_published: true, display_order: 4,
    published_at: new Date().toISOString(),
  },
  {
    ...
    content_long: "", implications: "", image_url: null, original_url: "#",
    category: "TOURISM", priority_score: 80, is_published: false, display_order: 5,
    published_at: new Date().toISOString(),
  },
  {
    ...
    content_long: "", implications: "", image_url: null, original_url: "#",
    category: "STARTUP", priority_score: 75, is_published: false, display_order: 6,
    published_at: new Date().toISOString(),
  },
];
